...
%>
<c:set var="rootPage" value="<%= externalizer.publishLink(resourceResolver, "/") %>"/>
<c:set var="currentPagePath" value="<%=currentPage.getPath()%>"/>
<div class="inner">

    <usga:link path="${properties.logoDestination}" classes="logo" absolute="${JSONP}">
        <usga:data-img src="usga/cutups/logo/usga.png" data-crop="fit" linkChecker="skip" absolute="${JSONP}"/>
    </usga:link>
