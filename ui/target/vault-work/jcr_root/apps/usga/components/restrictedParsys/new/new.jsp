...
--%><%@ page session="false" import="
    ...
    if (editContext != null) {
        ...
        String emptyText = (String) request.getAttribute("restrictedParsysEmptyText");
        editContext.getEditConfig().setEmptyText(emptyText != null ? emptyText : "Drag components or assets here.");
        request.removeAttribute("restrictedParsysEmptyText");
    }
