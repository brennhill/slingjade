                ...
                {{#rules}}
                    <div class="rule-book__side__item__box">
                        ...
                        <div class="rule-book__side__item__box__list open sub off rule{{itemId}}Navigation">
                            <a href="javascript:void(0);" class="rule-book__side__item__box__list__link" itemId="{{itemId}}">{{text}}</a>
    ...
    {{/sections}}
            ...
            <script>
                var blockRuleBook = new usga.RuleBook('#blockRuleBook', {
                    feedUrl: '${not empty pageProperties.ruleBookFeed ? pageProperties.ruleBookFeed : '/etc/designs/usga/data/rule-book.json'}',
                    baseUrl: '${not empty pageProperties.rulesLocation ? pageProperties.rulesLocation : '/etc/designs/usga/content/rule-book/'}'
                });
            </script>
