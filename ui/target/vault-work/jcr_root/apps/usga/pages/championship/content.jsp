...
<div class="wrapper">
    <!-- content part-->
    <div class="content">
        <cq:include path="topContentPar" resourceType="foundation/components/parsys"/>

        <cq:include path="championshipcontainer" resourceType="usga/components/championshipContainer"/>
