    ...
    {{/sections}}
            ...
            <script>
                var blockRuleBook = new usga.RuleBook('#blockRuleBook', {
                    feedUrl: '${not empty pageProperties.ruleBookFeed ? pageProperties.ruleBookFeed : '/etc/designs/usga/data/handicap-manual-rule-decision.json'}',
                    baseUrl: '${not empty pageProperties.rulesLocation ? pageProperties.rulesLocation : '/etc/designs/usga/content/rule-book/handicap-manual/'}',
                    currentSelectedRule: '14367',
                    decisions: [14367, 14370, 14373, 14377, 14379, 14381, 14385, 14387, 14389, 14401]
                });
            </script>
