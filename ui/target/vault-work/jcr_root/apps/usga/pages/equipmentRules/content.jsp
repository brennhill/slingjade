    ...
    {{/sections}}
            ...
            <script>
                var blockRuleBook = new usga.RuleBook('#blockRuleBook', {
                    feedUrl: '${not empty pageProperties.ruleBookFeed ? pageProperties.ruleBookFeed : '/etc/designs/usga/data/clubs-balls-rule.json'}',
                    baseUrl: '${not empty pageProperties.rulesLocation ? pageProperties.rulesLocation : '/etc/designs/usga/content/rule-book/clubs-balls/'}',
                    currentSelectedRule: '14606'
                });
            </script>
